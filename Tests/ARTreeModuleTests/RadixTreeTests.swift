...
final class RadixTreeCollectionTests: CollectionTestCase {
  ...
  func testRemoveValueDoesNotLoseUnrelatedKeys() throws {
    ...
    t.updateValue(3, forKey: "aaQzz")

    t.removeValue(forKey: "aaQzz")

    expectEqual(t.getValue(forKey: "aaXmp"), 1)
    expectEqual(t.getValue(forKey: "aaXmq"), 2)
    expectEqual(t.getValue(forKey: "aaQzz"), nil)
  }
}
